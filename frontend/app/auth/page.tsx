...
export default function Dashboard() {
  ...
  const handleCreateFolder = async () => {
    ...
    try {
      console.log('FOLDER CREATE: Starting folder creation')
      const response = await fetch(`${API_URL}/api/features/folders/create`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        console.log('FOLDER CREATE: Error', error)
        alert(`Error: ${error.message}`)
      }
    } catch (error) {
      console.log('FOLDER CREATE: Exception', error)
